...
namespace DevelopmentChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        //---- armo una prueba para el rectangulo con rta en italiano
        [TestCase]
        public void TestResumenListaConUnRectangulo()
        {
            var rectangulos = new List<FormaGeometrica> { new FormaGeometrica(FormaGeometrica.Rectangulo, 2) };

            var resumen = FormaGeometrica.Imprimir(rectangulos, FormaGeometrica.Italiano);

            Assert.AreEqual("<h1> Rapporto forma </h1> 1 Rettangolo | Area 25 | Perimetro 20 <br/> TOTALE:<br/> 1 forma Perimetro 20 Area 25", resumen);
        }
        ...
        public void TestResumenListaConMasTipos()
        {
            var formas = new List<FormaGeometrica>
            {
                ...
                new FormaGeometrica(FormaGeometrica.Rectangulo, 3),
        ...
        //---- armo un caso con variable y respuesta en Italiano
        [TestCase]
        public void TestResumenListaConMasTiposEnItaliano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(forme, FormaGeometrica.Italiano);

            Assert.AreEqual(
                "<h1>Rapporto forma</h1>2 quadrati | Area 29 | Perimetro 28 <br/>2 cerchi | Area 13.01 | Perimetro 18.06 <br/>3 triangoli | Area 49.64 | Perimetro 51,6 <br/>TOTALE:<br/>7 forme Perimetro 97,66 Area 91,65",
                resumen);
        }
    }
}
